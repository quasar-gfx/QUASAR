...
public:
    ...
    RenderStats drawObjects(const Scene &scene, const PerspectiveCamera &camera, uint32_t clearMask = GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT) override;
