...
public:
    ...
    virtual RenderStats draw(const VRCamera cameras, const glm::mat4 &model, bool frustumCull = true, const Material* overrideMaterial = nullptr) = 0;
    virtual RenderStats draw(const VRCamera cameras, const glm::mat4 &model, const BoundingSphere &boundingSphere, const Material* overrideMaterial = nullptr) = 0;
