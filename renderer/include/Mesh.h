...
public:
    ...
    static Mesh* create(std::vector<Vertex> &vertices, std::vector<Texture*> &textures, float shininess = 0.0f) {
        return new Mesh(vertices, textures, shininess);
    }

    static Mesh* create(std::vector<Vertex> &vertices, std::vector<unsigned int> &indices, std::vector<Texture*> &textures, float shininess = 0.0f) {
...
private:
    ...
    Mesh(std::vector<Vertex> &vertices, std::vector<Texture*> &textures, float shininess = 0.0f)
